...
interface TestPageProps extends ComponentPropsWithoutRef<"div"> {}
      ...
      >
        ...
        >
          <Button size="small">
            ...
            Recusandae, tempore? Earum sit est aliquid recusandae esse non error
            minima distinctio? Ex vero quod animi architecto, sint quo
            laboriosam laudantium. Sunt ex dignissimos deleniti rem odit
            adipisci expedita ad nobis eligendi deserunt. Error quos tempore
            quia ullam hic ducimus cumque impedit vel fuga, rerum suscipit iure
            libero dolore voluptas eaque magni quod blanditiis quibusdam sint
            fugit illo vitae quae! Voluptatem illum quo nemo iusto cupiditate
            deleniti, sint numquam fuga optio rem, expedita ut ducimus,
            architecto aut a quaerat quas vitae dolor officia! Aperiam, repellat
            ab quod fuga quia distinctio vitae pariatur.
          </Button>
        ...
        <span>
          ...
          minus magni ipsum praesentium nemo! Sequi voluptas explicabo at
          quisquam a, minus id eius mollitia quis blanditiis, ea iste omnis,
          nulla fugiat? Sint nihil quae dolor ab ipsam modi, nostrum voluptates,
          voluptas dicta excepturi quas animi. Architecto impedit aliquam
          obcaecati iusto est quas mollitia minus voluptatem expedita ex
          debitis, consequatur, unde perferendis in ad nobis quidem consequuntur
          quod laboriosam deleniti at provident! Nesciunt eum dignissimos quasi
          ex eveniet libero ut ad hic. Saepe consectetur aliquam maxime eligendi
          rerum architecto quas possimus adipisci.
        </span>
